...
# all_gbif <- read_delim(here("data/gbif/gbif_afr_species.csv"), 
...
spp_count_top_50 <- spp_count[1:50,]

write_csv(spp_count_top_50, 'data/gbif/most_sampled_mad_plants.csv')
