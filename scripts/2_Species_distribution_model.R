# RGB Kew MSc Spatial Analysis Course 2022
# Joseph White, Nicola Kuhn, Carolina Tovar
...
head(cbind(SWDdata@pa,SWDdata@data), 20)
...
# first convert the protected areas
prot_areas_all %>% 
  st_transform(crs = 'EPSG:29702') -> prot_areas_all_proj
# next convert the presence/absence raster
pred_th %>% 
